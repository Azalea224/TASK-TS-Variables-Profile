...
let fullName: string=`Aziz AlHumaidan`;
let yearOfBirth: number=2001;
let hobby: string=`gaming and coding`;
let funFact: string=`i love coding and gaming`;
let image: string=`https://images8.alphacoders.com/481/thumb-1920-481545.jpg`;
